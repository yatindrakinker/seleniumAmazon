...
public class DbData {
	...
	private List<String> additional_images;
	...
	private List<Object> variant_attributes_values;
	...
	public List<String> getAdditional_images() {
		return additional_images;
	}

	public void setAdditional_images(List<String> additional_images) {
	...
	public Object getTemplate_suffix() {
		return template_suffix;
	}

	public void setTemplate_suffix(Object template_suffix) {
	...
	public List<Object> getVariant_attributes_values() {
		return variant_attributes_values;
	}

	public void setVariant_attributes_values(List<Object> variant_attributes_values) {
	...
	public Object getVariant_image() {
		return variant_image;
	}

	public void setVariant_image(Object variant_image) {
